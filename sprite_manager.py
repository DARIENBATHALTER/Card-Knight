...
def _load_oden_sprites():
    ...
    def _load_dir(direction: str) -> list:
        ...
        Frames are loaded RAW (no trimming / rescaling). The overworld scales each
        frame to CHAR_H by its own height and centres it — this is the rendering
        that shipped and looked right; do NOT re-introduce per-direction
        normalisation here (it distorted scale/positioning)."""
